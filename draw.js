/**
		...
		@param {Object} treeObj - An object that contains the full tree and the root of the tree
...
/**
		@function calculateHeightRecur
		@param {Object} tree - The full tree object
		@param {string} idx - The current node
		@returns {number} - The height of the tree
		*/
...
/**
		...
		@param {HTMLCanvasElement} canvas - The canvas element on which the tree will be drawn
...
/**
		...
		@param {Object} fullTree - The full tree object
		@param {string} currentNode - The current node
		@param {number} xOffset - The x offset of the current node
		@param {number} height - The height of the current node
		@param {number} allowableWidth - The allowable width for the current node
*/
